...
public class ConnectFourAI {
	...
	public int minimax(int depth, int turn, int alpha, int beta) {
		...
		for (int j = 0; j <= 6; ++j) {
			...
			// TODO: initialize variable for current score
			int currentScore = 0;
			...
			if (turn == 1) {
				...
				// TODO: get currentScore (recursive minimax call)
				currentScore = minimax(depth + 1, 2, alpha, beta);
				
				// if at root
				if (depth == 0) {
					// TODO: print score for location j
					System.out.println("Score for location " + j + ": " + currentScore);
					
					// TODO: set nextMoveLocation based on currentScore
			...
			// else if second player
				...
				// TODO: get current score (recursive minimax call)
				currentScore = minimax(depth + 1, 1, alpha, beta);
				
				// TODO: update minScore
